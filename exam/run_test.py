...
dict_test[24] = ["3",      "NavfnROS_navguide", "teb_acc_1_5_forward_drive_200_best" ]
...
for i, test in enumerate(dict_test.keys()):
    ...
    print(f"roslaunch exam demo.launch sim:=False num_path:={t[0]} global_planner_param_demo:={t[1]} local_planner_param_demo:={t[2]} bag_name:={bag_name}")
