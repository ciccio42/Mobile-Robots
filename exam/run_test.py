...
dict_test[6] = ["1",      "NavfnROS", "teb_default" ]
...
# dict_test[16] = ["1",      "Global_A*_navguide", "teb"]
# dict_test[17] = ["2",      "Global_A*_navguide", "teb"]
# dict_test[18] = ["3",      "Global_A*_navguide", "teb" ]
...
# dict_test[22] = ["1",      "NavfnROS_navguide", "teb_acc_1_9_forward_drive_200"]
# dict_test[23] = ["2",      "NavfnROS_navguide", "teb_acc_1_9_forward_drive_200"]
# dict_test[24] = ["3",      "NavfnROS_navguide", "teb_acc_1_9_forward_drive_200" ]
...
for i, test in enumerate(dict_test.keys()):
    ...
    os.system (f"roslaunch exam demo.launch sim:=True num_path:={t[0]} global_planner_param_demo:={t[1]} local_planner_param_demo:={t[2]} bag_name:={bag_name} run_aip:='True' sim:='True'")
